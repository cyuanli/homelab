...
kubectl apply -f "$SCRIPT_DIR/storage-cache-pvs.yaml"
kubectl apply -f "$SCRIPT_DIR/storage-cache-pvcs.yaml"
...
echo ""
echo "📍 Access Immich at: https://photos.cliff.li"
echo ""
echo "📝 Next steps:"
echo "   1. Configure DNS to point photos.cliff.li to your cluster"
