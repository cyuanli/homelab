...
- `notify.sh` - Discord notification script for backup success/failure alerts
...
### 2. Configure Borgmatic
Create your borgmatic configuration:
```bash
...
BORGMATIC_WEBHOOK_URL="your_webhook_url" ./notify.sh success

# Test failure notification
BORGMATIC_WEBHOOK_URL="your_webhook_url" ./notify.sh exit-code
```
...
### Notification Script
The `notify.sh` script sends Discord notifications for both successful and failed backups, including recent log entries for failures.